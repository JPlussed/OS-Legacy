...
final class ObjectManager {
	...
	//hungry as fuck - poesy700 2 0l1o5l
                                            ...
                                            if (l18 > 0 || i19 > 0) {
                                                    ...
                                                    if (i19 == 0) {
                        	                                ...
                        	                                if (textureId == 51)
                        	                                	textureId = 3;
                        									if (textureId > 50) {
                        										System.out.println(textureId+"soz");
                        										textureId = -1;
                        									}
                        									if (textureId >= 0) {
                        	                                 ...
                        	                                 //   textureId = -1;
                        	                                    ...
                        	                                    k23 = Rasterizer.anIntArray1482[method185(overlay_flo.hsl16, 96)];                                
                        	                                    j23 = -2;
                        	                                 //   textureId = -1;
                        	                                } else {
                        								    ...
                        								    if (k23 == 0x000000 && overlay_flo.anotherRgb != -1) {
                        	                                    int temporaryMinimapColor = hslToRgb(overlay_flo.anotherHue,
...
label0:
	...
	public final void method174(int i, int j, int l, int i1)
	{
        ...
        int actualH = k;
        if(actualH ==0) {
            if (actualX >= 3094 && actualX <= 3097 && actualY >= 3506 && actualY <= 3506 || //bottom edge building wall
                    actualX >= 3093 && actualX <= 3098 && actualY >= 3507 && actualY <= 3511 || //inner space edge building
                    actualX >= 3095 && actualX <= 3096 && actualY >= 3514 && actualY <= 3514 || //upper wall edge building
                    actualX >= 3094 && actualX <= 3096 && actualY >= 3513 && actualY <= 3513 || //shelves
                    actualX >= 3093 && actualX <= 3093 && actualY >= 3513 && actualY <= 3513 || //shelves
                    actualX >= 3097 && actualX <= 3097 && actualY >= 3513 && actualY <= 3513 || //shelves
                    actualX >= 3093 && actualX <= 3094 && actualY >= 3487 && actualY <= 3487 || //bank lower wall
                    actualX >= 3092 && actualX <= 3095 && actualY >= 3488 && actualY <= 3488 || //bank lower inner wall

                    actualX >= 3091 && actualX <= 3091 && actualY >= 3489 && actualY <= 3491 || //bank west doors
                    actualX >= 3090 && actualX <= 3090 && actualY >= 3489 && actualY <= 3489 || //bank west doors

                    actualX >= 3091 && actualX <= 3091 && actualY >= 3510 && actualY <= 3510 || //hay
                    actualX >= 3099 && actualX <= 3099 && actualY >= 3511 && actualY <= 3511 || //hay

                    actualX >= 3093 && actualX <= 3095 && actualY >= 3474 && actualY <= 3474 || //south edge wall
                    actualX >= 3094 && actualX <= 3096 && actualY >= 3490 && actualY <= 3490 || //test
                    actualX >= 3094 && actualX <= 3096 && actualY >= 3492 && actualY <= 3492 || //test
                    actualX >= 3097 && actualX <= 3097 && actualY >= 3493 && actualY <= 3494 || //test

                    actualX >= 3088 && actualX <= 3088 && actualY >= 3509 && actualY <= 3509) //cart
                return;
        }
	{
