...
/*	public void updatePlayer(Stream stream)
	{
		...
		if(super.anInt1505 == 65535)
			super.anInt1505 = -1;
		name = TextClass.formatUsername(TextClass.decodeBase37(stream.readQWord()));
		combatLevel = stream.readUnsignedByte();
		skill = stream.readUnsignedWord();
		visible = true;
		aLong1718 = 0L;
	...
	public Model method452()
	{
		...
		if(model_1 == null)
		{
			...
			for(int j3 = 0; j3 < 5; j3++)
				...
				{
					model_1.method476(Client.anIntArrayArray1003[j3][0], Client.anIntArrayArray1003[j3][anIntArray1700[j3]], ItemDef.getTexture(-1));
					if(j3 == 1)
						model_1.method476(Client.anIntArray1204[0], Client.anIntArray1204[anIntArray1700[j3]], ItemDef.getTexture(-1));
				}
	...
	public Model method453()
	{
		...
		for(int j1 = 0; j1 < 5; j1++)
			...
			{
				model.method476(Client.anIntArrayArray1003[j1][0], Client.anIntArrayArray1003[j1][anIntArray1700[j1]], ItemDef.getTexture(-1));
				if(j1 == 1)
					model.method476(Client.anIntArray1204[0], Client.anIntArray1204[anIntArray1700[j1]], ItemDef.getTexture(-1));
			}
