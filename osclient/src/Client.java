...
public class Client extends RSApplet {
 ...
 //	}
     ...
     */
    public static String clientName = "OS-WORLD";
    ...
    public void readSettings() throws IOException {
        try {
            File yourFile = new File(Signlink.findcachedir() + "settings.dat");
            if (!yourFile.exists()) {
                yourFile.createNewFile();
            }
            DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream(yourFile)));
            in.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void writeSettings() throws IOException {
        try {
            DataOutputStream out = new DataOutputStream(
                    new BufferedOutputStream(new FileOutputStream(Signlink.findcachedir() + "settings.dat")));
            out.close();
        } catch (Exception e) {
        }
    }
    ...
    public static boolean changeTabArea = Configuration.clientSize == 0 ? false : true;
    public static boolean changeChatArea = Configuration.clientSize == 0 ? false : true;
    ...
    public void toggleSize(int size) {
        ...
        showChatComponents = Configuration.clientSize == 0 ? true : showChatComponents;
        showTabComponents = Configuration.clientSize == 0 ? true : showTabComponents;
    }
    ...
    public boolean getMousePositions() {
		...
		if (!changeTabArea) {
			if (super.mouseX > 0 && super.mouseY > 0 && super.mouseY < Configuration.clientWidth && super.mouseY < Configuration.clientHeight) {
				if (super.mouseX >= Configuration.clientWidth - 242 && super.mouseY >= Configuration.clientHeight - 335) {
					return false;
				}
				return true;
			}
    ...
    public boolean mouseMapPosition() {
        if (super.mouseX >= Configuration.clientWidth - 21 && super.mouseX <= Configuration.clientWidth
    ...
    //private final int[] modeX = { }, modeNamesX = { },
        //   modeNamesY = {  }, channelButtonsX = { };
   ...
   private final int[] modeX = { 164, 230, 296, 362 }, modeNamesX = { 26, 86, 150, 212, 286, 349, 427 },
    ...
    private final String[] modeNames = { "All", "Game", "Public", "Private", "Clan", "Trade" , ""};
    ...
    public void drawChannelButtons() {
		...
		DateFormat timestamp_format = new SimpleDateFormat("hh:mm a");
		String currentTime = timestamp_format.format(new Date());
		smallText.method389(true, 438, 0xffffff, currentTime.toString(), Configuration.clientSize == 0 ? 152 : Configuration.clientHeight - 12);
		smallText.method389(true, 433, 0xffffff, currentDate.toString(), Configuration.clientSize == 0 ? 162 : Configuration.clientHeight - 2);
        switch (cButtonCPos) {
        case 0:
        case 1:
        case 2:
    ...
    private void drawChatArea() {
        ...
        if (super.saveClickX >= 0 && super.saveClickX <= 522
				&& super.saveClickY >= 343 && super.saveClickY <= 484) {
        ...
        if (messagePromptRaised) {
            ...
            for (int k = 0; k < 500; k++) {
                if (chatMessages[k] != null) {
                    ...
                    if (s1 != null && s1.startsWith("@cr1@")) {
                        ...
                        s1 = s1.substring(6);
                        byte0 = 14;
                    } else if (s1 != null && s1.startsWith("@cr32@")) {
                        s1 = s1.substring(6);
                        byte0 = 32;
                    } else if (s1 != null && s1.startsWith("@cr31@")) {
                        s1 = s1.substring(6);
                        byte0 = 31;
                } else if (s1 != null && s1.startsWith("@cr28@")) {
                    s1 = s1.substring(6);
                    byte0 = 16;
                
            } else if (s1 != null && s1.startsWith("@cr27@")) {
                s1 = s1.substring(6);
                byte0 = 15;
            }
                    if (chatType == 0) {
                        if (chatTypeView == 5 || chatTypeView == 0) {
                            if (yPos > 0 && yPos < 210) {
                                newRegularFont.drawBasicString(chatMessages[k], 11, yPos + yOffset, 0, -1);
                            }
                            j++;
                            j77++;
                        }
                    ...
                    if ((chatType == 1 || chatType == 2)
                     ...
                     xPos += 14;
                           ...
                           modIcons[15].drawSprite(xPos + 1, yPos - 12 + yOffset);
                           xPos += 14;
                            
                    } else if (byte0 == 32) {
                        modIcons[31].drawSprite(xPos + 1, yPos - 12 + yOffset);
                        xPos += 14;
                         
                    } else if (byte0 == 31) {
                        modIcons[30].drawSprite(xPos + 1, yPos - 12 + yOffset);
                        xPos += 14;
                         
                        } else if (byte0 == 17) {
                            modIcons[16].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 18) {
                            modIcons[17].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 19) {
                            modIcons[18].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 20) {
                            modIcons[19].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 21) {
                            modIcons[20].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 22) {
                            modIcons[21].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 23) {
                            modIcons[22].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 24) {
                            modIcons[23].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 25) {
                            modIcons[24].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            
                        } else if (byte0 == 26) {
                            modIcons[25].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;

                        } else if (byte0 == 27) {
                            modIcons[26].drawSprite(xPos + 1, yPos - 12 + yOffset);
                            xPos += 14;
                            ...
                            xPos += 14;
                                ...
                                newRegularFont.drawBasicString(s1 + ":", xPos, yPos + yOffset, 0, -1);
                                xPos += newRegularFont.getTextWidth(s1) + 8;
                                newRegularFont.drawBasicString(chatMessages[k], xPos, yPos + yOffset, 255, -1);
                            }
                            j++;
                            j77++;
                        }
                        ...
                        if (chatTypeView == 2 || chatTypeView == 0) {
                            if (yPos > 0 && yPos < 210) {
                                ...
                                if (byte0 == 1) {
                                    ...
                                    modIcons[13].drawSprite(k1, yPos - 12 + yOffset);
                                    k1 += 12;
                                
                                } else if (byte0 == 15) {
                                	modIcons[14].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                            
                                } else if (byte0 == 16) {
                                	modIcons[15].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                } else if (byte0 == 32) {
                                	modIcons[31].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 31) {
                                	modIcons[30].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                	
                                } else if (byte0 == 17) {
                                	modIcons[16].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 18) {
                                	modIcons[17].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 19) {
                                	modIcons[18].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 20) {
                                	modIcons[19].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 21) {
                                	modIcons[20].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 22) {
                                	modIcons[21].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 23) {
                                	modIcons[22].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 24) {
                                	modIcons[23].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 25) {
                                	modIcons[24].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                	
                                } else if (byte0 == 26) {
                                	modIcons[25].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;

                                } else if (byte0 == 27) {
                                	modIcons[26].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;

                                } else if (byte0 == 28) {
                                	modIcons[27].drawSprite(k1, yPos - 12 + yOffset);
                                	k1 += 12;
                                ...
                                newRegularFont.drawBasicString(chatMessages[k], k1, yPos + yOffset, 0x800000, -1);
                            }
                            j++;
                            j77++;
                        }
                    ...
                    if (chatType == 5 && splitPrivateChat == 0 && privateChatMode < 2) {
                        if (chatTypeView == 2 || chatTypeView == 0) {
                            newRegularFont.drawBasicString(chatMessages[k], 11, yPos + yOffset, 0x800000, -1);
                            j++;
                            j77++;
                        }
                    }
                        ...
                        if (chatTypeView == 2 || chatTypeView == 0) {
                            if (yPos > 0 && yPos < 210) {
                                ...
                                newRegularFont.drawBasicString(chatMessages[k],
                                        15 + newRegularFont.getTextWidth("To :" + s1), yPos + yOffset, 0x800000, -1);
                            }
                            j++;
                            j77++;
                        }
            ...
            if (myPrivilege == 0) { // Player
                newRegularFont.drawBasicString(fixedString + "", xPos + 11, 133 + yOffset, 0, -1);
                textDrawingArea.method385(0, ":", 133 + yOffset, (xPos + 11) + textDrawingArea.getTextWidth(s));
                ...
                xPos += 14;
                newRegularFont.drawBasicString(fixedString + "", xPos + 10, 133 + yOffset, 0, -1);
                textDrawingArea.method385(0, ":", 133 + yOffset, (xPos + 11) + textDrawingArea.getTextWidth(s));
                newRegularFont.drawBasicString(inputString + ("*"), xPos + 12 + textDrawingArea.getTextWidth(s + " :"),
                        133 + yOffset, 255, -1);
                DrawingArea.method339(121 + yOffset, 0x807660, 506, 7);
                ...
                newRegularFont.drawBasicString(inputString + ("*"), xPos + 12 + textDrawingArea.getTextWidth(s + " :"),
                        133 + yOffset, 255, -1);
                DrawingArea.method339(121 + yOffset, 0x807660, 506, 7);
            } else if (myPrivilege == 14) { // Veteran
                ...
                newRegularFont.drawBasicString(inputString + ("*"), xPos + 12 + textDrawingArea.getTextWidth(s + " :"),
                        133 + yOffset, 255, -1);
                DrawingArea.method339(121 + yOffset, 0x807660, 506, 7);
            } else if (myPrivilege == 15) { // Ironman
                modIcons[14].drawSprite(10 + xPos, 122 + yOffset);
                xPos += 14;
                newRegularFont.drawBasicString(fixedString + "", xPos + 11, 133 + yOffset, 0, -1);
                textDrawingArea.method385(0, ":", 133 + yOffset, (xPos + 11) + textDrawingArea.getTextWidth(s));
                newRegularFont.drawBasicString(inputString + ("*"), xPos + 12 + textDrawingArea.getTextWidth(s + " :"),
                        133 + yOffset, 255, -1);
                DrawingArea.method339(121 + yOffset, 0x807660, 506, 7);
            } else if (myPrivilege == 31) { // elite
                modIcons[30].drawSprite(10 + xPos, 122 + yOffset);
                xPos += 14;
                newRegularFont.drawBasicString(fixedString + "", xPos + 11, 133 + yOffset, 0, -1);
                textDrawingArea.method385(0, ":", 133 + yOffset, (xPos + 11) + textDrawingArea.getTextWidth(s));
                newRegularFont.drawBasicString(inputString + ("*"), xPos + 12 + textDrawingArea.getTextWidth(s + " :"),
                        133 + yOffset, 255, -1);
                DrawingArea.method339(121 + yOffset, 0x807660, 506, 7);
            } else if (myPrivilege == 32) { // legendary
                modIcons[31].drawSprite(10 + xPos, 122 + yOffset);
                xPos += 14;
                newRegularFont.drawBasicString(fixedString + "", xPos + 11, 133 + yOffset, 0, -1);
                textDrawingArea.method385(0, ":", 133 + yOffset, (xPos + 11) + textDrawingArea.getTextWidth(s));
                newRegularFont.drawBasicString(inputString + ("*"), xPos + 12 + textDrawingArea.getTextWidth(s + " :"),
                        133 + yOffset, 255, -1);
                DrawingArea.method339(121 + yOffset, 0x807660, 506, 7);
            } else if (myPrivilege == 16) { // Ultimate ironman
                modIcons[15].drawSprite(10 + xPos, 122 + yOffset);
                xPos += 14;
                newRegularFont.drawBasicString(fixedString + "", xPos + 11, 133 + yOffset, 0, -1);
                textDrawingArea.method385(0, ":", 133 + yOffset, (xPos + 11) + textDrawingArea.getTextWidth(s));
                newRegularFont.drawBasicString(inputString + ("*"), xPos + 12 + textDrawingArea.getTextWidth(s + " :"),
    ...
    public void preloadModels() {
        ...
        for (int y = 0; y < fileArray.length; y++) {
            ...
            System.out.println("Model loaded: " + getFileNameWithoutExtension(s));
		}
	}
								...
								if (class9_1.inv[k2] > 0) {
									...
									if (itemSelected == 1
										...
										if (class9_1.usableItemInterface) {
											...
											//if(RSApplet.keyevent.isShiftDown()){
                ...
                if (tabInterfaceIDs[sideIconsTab[i]] != -1) {
                    if (iconId[i] != -1) {
                       ...
                       sideIcons[iconId[i]].drawSprite(Configuration.clientWidth - iconX[i],
                        ...
                        if (iconId[i] == 13) {
							equipmentIcon[0].drawSprite(Configuration.clientWidth - iconX[i], Configuration.clientHeight - iconY[i]);
						} else {
							//fucking piece of shit cacheSprite[iconId[i]].drawSprite(Configuration.clientWidth - iconX[i], Configuration.clientHeight - iconY[i]);
						}
                    }
                }
            }
                ...
                if (tabInterfaceIDs[sideIconsTab[i]] != -1) {
                    if (iconId[i] != -1) {
                       sideIcons[iconId[i]].drawSprite(Configuration.clientWidth - 461 + iconX[i],
                           Configuration.clientHeight - iconY[i]);
                    }//sure ur editing the correct cache, normaly u wouldnt be able to open it an sec
                }
            }
        }
    }
   ...
   // private boolean toggleRoof = false;
    ...
    private void loadingStages() {
        if (lowMem && loadingStage == 2 && ObjectManager.anInt131 != plane) {
            ...
            aTextDrawingArea_1271.drawText(0x2d2d2d, "Loading - please wait.", 150, 256);
	...
	void drawLoadingText(int i, String s) {
		...
		chatTextDrawingArea.drawText(0xffffff,
				"OS-WORLD is loading - please wait...", c1 / 2 - 26 - byte1,
				c / 2);
		int j = c1 / 2 - 18 - byte1;
    ...
    private void doAction(int i) {
       ...
       /* if (l == 104) {
        ...
        if (l == 315) {
            ...
            if (flag8) {
                ...
                case 31041:
                    ...
                    break;
                case 31022:
                    launchURL(Configuration.STORE_DOCUMENT_BASE);
                    break;
                case 31108:
                ...
                case 36004://fixed
                	toggleSize(0);
                break;
        		case 14407: //options tab
                    loadOrbs = !loadOrbs;
                    pushMessage("You haved toggled Orbs", 0, "");
                break;
        		case 14411: //options tab
        			//  Configuration.distanceFog = !Configuration.distanceFog;
        			  Configuration.hdTexturing = !Configuration.hdTexturing;
        			  Configuration.smoothShading = !Configuration.smoothShading;
        		      pushMessage("You haved toggled HD", 0, "");
                break;
        		case 33589: //options tab
        		      pushMessage("You haved toggled shiftdrop", 0, "");
        			shiftDrop = !shiftDrop;
                break;
        		case 14408: //options tab
                    if (Configuration.clientSize != 0) {
                        pushMessage("You haved toggled Transparent Chatbox", 0, "");
                        changeChatArea = !changeChatArea;
                    }
                break;
        		case 14409: //options tab
                    if (Configuration.clientSize != 0) {
                        changeTabArea = !changeTabArea;
                        pushMessage("You haved toggled Side-stone Arrangement", 0, "");
                    }
                break;
        		case 14404: //options tab
                    if (Configuration.clientSize != 0) {
                        transparentTabArea = !transparentTabArea;
                        pushMessage("You haved toggled Transparent Side-panel", 0, "");
                    }
                break;
        		case 14410: //options tab
        		      pushMessage("You haved toggled HP Overlay", 0, "");
          		  hpOverlayOn = !hpOverlayOn;
                break;
        ...
        if (l == 1026) {
        	Npc currentNpc = npcArray[i1];

        	if (currentNpc != null) {
        		
        		EntityDef npcDef = currentNpc.desc;
        		if (npcDef != null) {
        			String tmp = inputString;
        		
        			inputString = "::drops "+npcDef.name;
        ...
        do {
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
						...
						if (subcomponent != null && scroll != null
							...
							int[] results = ItemDef
									.getResults(
											...
											60,
											variousSettings[toggle.valueIndexArray[0][1]] == toggle.anIntArray212[0] ? true
													: false);
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                	if (inputString.equals("::shiftdrop"))
                		shiftDrop = !shiftDrop;
                	  if (inputString.equals("::fpson"))
                          fpsOn = true;
                	  if (inputString.equals("::hptoggle")) { 
                		  hpOverlayOn = !hpOverlayOn;
                	  }
                	  if (inputString.equals("::xpmerge")) { 
                		  xp_merge = !xp_merge;
                	  }
                	...
                	if (myPrivilege == 2 || server.equals("127.0.0.1")) {
                       ...
                       /* if (inputString.equals("::lattack")) {
                          ...
                          // this.pushMessage("Configuration.isOneClick");
                        }*/
                        ...
                        if (inputString.equals("::u")) {
    						TextDrawingArea aTextDrawingArea_1273 = new TextDrawingArea(
    								true, "q8_full", titleStreamLoader);
    						TextDrawingArea aclass30_sub2_sub1_sub4s[] = {
    								smallText, aTextDrawingArea_1271,
    								chatTextDrawingArea, aTextDrawingArea_1273 };
    						StreamLoader streamLoader_1 = streamLoaderForName(3,
    								"interface", "interface", expectedCRCs[3], 35);
    						StreamLoader streamLoader_2 = streamLoaderForName(4,
    								"2d graphics", "media", expectedCRCs[4], 40);
    						RSInterface.unpack(streamLoader_1,
    								aclass30_sub2_sub1_sub4s, streamLoader_2);
    					}
                        if (inputString.equals("::dataon"))
                            clientData = true;
                        if (inputString.equals("::dataoff"))
  ...
  public void drawFriendsListOrWelcomeScreen(RSInterface class9) {
        ...
        for (int j = 0; j < 100; j++) {
            if (chatMessages[j] != null) {
                ...
                if ((k == 3 || k == 7)
					...
					if (byte1 == 2) {
						modIcons[1].drawSprite(k1 - 2, l - 13);
						k1 += 12;
					}
					if (byte1 == 3) {
						modIcons[2].drawSprite(k1 - 2, l - 12);
						k1 += 12;
					}
					if (byte1 == 4) {
					...
					if (byte1 == 14) {
						modIcons[13].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 15) {
					...
					if (byte1 == 16) {
						modIcons[15].drawSprite(k1, l - 11);
						k1 += 12;
				}
					if (byte1 == 32) {
						modIcons[31].drawSprite(k1, l - 11);
						k1 += 12;
				}
					if (byte1 == 31) {
						modIcons[30].drawSprite(k1, l - 11);
						k1 += 12;
				}
					if (byte1 == 17) {
						modIcons[16].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 18) {
						modIcons[17].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 19) {
						modIcons[18].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 20) {
						modIcons[19].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 21) {
						modIcons[20].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 22) {
						modIcons[21].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 23) {
						modIcons[22].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 24) {
						modIcons[23].drawSprite(k1, l - 11);
						k1 += 12;
					}
					if (byte1 == 25) {
						modIcons[24].drawSprite(k1, l - 11);
						k1 += 12;
					}
					
					if (byte1 == 26) {
						modIcons[25].drawSprite(k1, l - 11);
						k1 += 12;
					}

					if (byte1 == 27) {
						modIcons[26].drawSprite(k1, l - 11);
						k1 += 12;
					}

					if (byte1 == 28) {
						modIcons[27].drawSprite(k1, l - 11);
						k1 += 12;
					}
    ...
    private final void minimapHovers() {
		...
		//132-165
		runHover = fixed ? super.mouseX >= 558 && super.mouseX <= 613 && super.mouseY >= 120 && super.mouseY < 150 : super.mouseX >= Configuration.clientWidth - 174 && super.mouseX <= Configuration.clientWidth - 120 && super.mouseY >= 120 && super.mouseY < 150;
            ...
            if (Configuration.clientSize == 0 || Configuration.clientSize != 0 && !changeTabArea) {
               ...
               if (super.saveClickX >= Configuration.clientWidth - 97
                ...
                if (super.mouseY >= Configuration.clientHeight - 37 && super.mouseY <= Configuration.clientHeight) {
                    ...
                    if (super.mouseX >= Configuration.clientWidth - 31 && super.mouseX <= Configuration.clientWidth) {
                        if (tabID == 13) {
                            showTabComponents = !showTabComponents;
                        } else {
                            showTabComponents = true;
    ...
    public boolean validMousePosition() {
		if (Configuration.clientSize == 0) {
			...
			if (super.mouseX > 0 && super.mouseY > 0 && super.mouseX < Configuration.clientWidth && super.mouseY < Configuration.clientHeight) {
				...
				if (super.mouseX >= Configuration.clientWidth - 249 && super.mouseY >= Configuration.clientHeight - 335) {
					return false;
				}
				return true;
			}
 ...
 public void processRightClick() {
    ...
    private void login(String s, String s1, boolean flag) {
        ...
        try {
            ...
            socketStream = new RSSocket(this, openSocket(5555 + portOff));//SHOULD BE 5555 FOR OSWORLD
           ...
           // }
            if (k == 24) {
                loginMessage1 = "This world is running a closed Beta.";
                loginMessage2 = "Sorry invited players only.";
                return;
            }
            if (k == 25) {
         ...
         if (k == 23) {
              loginMessage1 = "There has been a Client Update.";
               loginMessage2 = "Please download the latest Client at Os-world.org";
               return;
           }
            if (k == -1) {
                if (i1 == 0) {
	...
	public Sprite[] ORBSNEW = new Sprite[34];
	...
	//repackCacheIndex(1);
        ...
        for (int i = 0; i <= 33; i++) {
			ORBSNEW[i] = new Sprite("Gameframe/ORBS " + i + "");
		}
        equipmentIcon[0] = new Sprite("icon 5");
        try {
            ...
            map1 = new Sprite("Icons/1");
            map2 = new Sprite("Icons/2");
            map3 = new Sprite("Icons/3");
            map4 = new Sprite("Icons/4");
            map5 = new Sprite("Icons/5");
            map6 = new Sprite("Icons/6");
	...
	private void method160(Entity entity) {
		int lastLoop = 0;
		lastLoop = 4;
		if (lastLoop > 0) {
			lastLoop--;
   ...
   //public static ScreenMode frameMode = ScreenMode.FIXED;
	...
	private void drawInterface(int j, int k, RSInterface class9, int l) {
        ...
        if (class9.isMouseoverTriggered && anInt1026 != class9.id && anInt1048 != class9.id && anInt1039 != class9.id)
            return;
        if (class9.parentID == 21200 && Configuration.clientSize == 1) {

            l -= 140;
            k += 270;
           }
        if (class9.parentID == 21200 && Configuration.clientSize == 2) {

            l -= 220;
            k += 505;
           }
        
        if (class9.parentID == 21300 && Configuration.clientSize == 2) {

            l -= 220;
            k += 505;
           }
        
        if (class9.parentID == 21300 && Configuration.clientSize == 1) {

            l -= 140;
            k += 270;
           }
        
        if (class9.parentID == 21400 && Configuration.clientSize == 1) {

            l -= 140;//160
            k += 270;
           }
       
        if (class9.parentID == 197 && Configuration.clientSize == 2) {
        	   l -= 220;
               k += 505;
           // l -= 480;
            //k += 705;//this one
        ...
        if (class9.parentID == 197 && Configuration.clientSize == 1) {
        	   l -= 220;
               k += 505;
           // l -= 160;
            //k += 270;
           }
        if (class9.parentID == 21400 && Configuration.clientSize == 2) {

            l -= 220;
            k += 505;
           }
        
          if (class9.parentID == 28000 & Configuration.clientSize == 1) {
       l -= 75;
           k -= 55;
          }
          if (class9.parentID == 16128 & Configuration.clientSize == 1) {
              l -= 245;
                 k += 75;
                 }
          
          if (class9.parentID == 16128 & Configuration.clientSize == 2) {
              l -= 737;
              k += 65;
              }
          if (class9.parentID == 16128 & Configuration.clientSize == 2) {
          ...
          if (class9.parentID == 21100 & Configuration.clientSize == 1) {
             l -= 85;
             k += 30;
             }
          if (class9.parentID == 21119 & Configuration.clientSize == 1) {
              l -= 75;
              k -= 100;
          }
          if (class9.parentID == 21119 & Configuration.clientSize == 2) {
              l -= 75;
              k -= 100;
          }
            ...
            if (class9_1.type == 0) {
                ...
                if (class9_1.type == 2) {
                    ...
                    if (class9_1.opacity == 0) {
                        ...
                        DrawingArea.method335(j3, l2, class9_1.width, class9_1.height, 256 - (class9_1.opacity & 0xff),
                                k2);
                    else
                        DrawingArea.method338(l2, class9_1.height, 256 - (class9_1.opacity & 0xff), j3, class9_1.width,
                                k2);
                    ...
                    if (spellSelected == 1 && class9_1.id == spellID && spellID != 0 && sprite != null) {
						...
						if (sprite != null)
							if(class9_1.drawsTransparent) {
								sprite.drawTransparentSprite(k2, l2, class9_1.transparency);
							} else {
					...
					int boxWidth = 0;
					int boxHeight = 0;
					String message = class9_1.message;
					...
					for (String s1 = message; s1.length() > 0;) {
						if (s1.indexOf("%") != -1) {
							do {
								...
								if (k7 == -1)
									break;
								s1 = s1.substring(0, k7) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 0)) + s1.substring(k7 + 2);
							} while (true);
							do {
								int l7 = s1.indexOf("%2");
								if (l7 == -1)
									break;
								s1 = s1.substring(0, l7) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 1)) + s1.substring(l7 + 2);
							} while (true);
							do {
								int i8 = s1.indexOf("%3");
								if (i8 == -1)
									break;
								s1 = s1.substring(0, i8) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 2)) + s1.substring(i8 + 2);
							} while (true);
							do {
								int j8 = s1.indexOf("%4");
								if (j8 == -1)
									break;
								s1 = s1.substring(0, j8) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 3)) + s1.substring(j8 + 2);
							} while (true);
							do {
								int k8 = s1.indexOf("%5");
								if (k8 == -1)
									break;
								s1 = s1.substring(0, k8) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 4)) + s1.substring(k8 + 2);
							} while (true);
						}
						int l7 = s1.indexOf("\\n");
						String s4;
					...
					for (int j11 = yPos + textDrawingArea_2.anInt1497 + 2; s2.length() > 0; j11 += textDrawingArea_2.anInt1497 + 1) {// anInt1497
						if (s2.indexOf("%") != -1) {
							do {
								...
								if (k7 == -1)
									break;
								s2 = s2.substring(0, k7) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 0)) + s2.substring(k7 + 2);
							} while (true);
							do {
								int l7 = s2.indexOf("%2");
								if (l7 == -1)
									break;
								s2 = s2.substring(0, l7) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 1)) + s2.substring(l7 + 2);
							} while (true);
							do {
								int i8 = s2.indexOf("%3");
								if (i8 == -1)
									break;
								s2 = s2.substring(0, i8) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 2)) + s2.substring(i8 + 2);
							} while (true);
							do {
								int j8 = s2.indexOf("%4");
								if (j8 == -1)
									break;
								s2 = s2.substring(0, j8) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 3)) + s2.substring(j8 + 2);
							} while (true);
							do {
								int k8 = s2.indexOf("%5");
								if (k8 == -1)
									break;
								s2 = s2.substring(0, k8) + NumberFormat.getIntegerInstance().format(extractInterfaceValues(class9_1, 4)) + s2.substring(k8 + 2);
							} while (true);
						}
						int l11 = s2.indexOf("\\n");
						String s5;
						...
						if (class9_1.centerText) {
							...
							if (s5.contains("\\r")) {
								...
								if (s5.contains(":") && !s5.contains("/") && class9_1.parentID == 3917) {
                ...
                drawInputField(class9_1, k, l, k2, l2, class9_1.width, class9_1.height);
	...
	long delayTimer = 0;
	public boolean hpOverlayOn = true;
	...
	public void hpOverlay() {
		...
		if (opponent1 instanceof Npc && ((Npc) opponent1).desc == null) {
			return;
		} 
		...
		if (System.currentTimeMillis() - delayTimer > 10000) {
			opponent1 = null;
			return;
		}

		String oponentsName = opponent1 instanceof Npc ? ((Npc) opponent1).desc.name : ((Player) opponent1).name;
		double oponentsMaxHealth = maxHealth;
		double oponentsHealth = currentHealth;
...
if (hpOverlayOn) { 
		...
		newSmallFont.drawCenteredString((int) oponentsHealth + " / " + (int) oponentsMaxHealth, 75, 49, 0xFDFDFD,
				10);
		newSmallFont.drawCenteredString(oponentsName, 75, 32, 0xFDFDFD, 10);
	}
}
   ...
   private void determineMenuSize() {
    ...
    private void drawMinimap() {
        ...
        if (anInt1021 == 2) {
            ...
            if (Configuration.clientSize == 0
                    ? super.mouseX >= 517 && super.mouseX <= 545 && super.mouseY >= 25 && super.mouseY <= 50
                    : super.mouseX >= Configuration.clientWidth - 185 && super.mouseX <= Configuration.clientWidth - 158
                            && super.mouseY >= 25 && super.mouseY <= 50) {
            	//185-158
            	//super.mouseX >= Configuration.clientWidth - 210 && super.mouseX <= Configuration.clientWidth - 190
              //  cacheSprite[23].drawSprite(
                   //     loadOrbs && Configuration.clientSize == 0 ? 1 : Configuration.clientWidth - 185,
                  //     g Configuration.clientSize == 0 ? 22 : 17);//46-3130 : 25
         //   } else {
             //   cacheSprite[22].drawSprite(
              //          loadOrbs && Configuration.clientSize == 0 ? 1 : Configuration.clientWidth - 185,
                   //     Configuration.clientSize == 0 ? 22 : 17);
            }
        ...
        markMinimap(map1, ((3094 - baseX) * 4 + 2) - myPlayer.x / 32, ((3501 - baseY) * 4 + 2) - myPlayer.y / 32);
        markMinimap(map2, ((3099 - baseX) * 4 + 2) - myPlayer.x / 32, ((3507 - baseY) * 4 + 2) - myPlayer.y / 32);
        markMinimap(map3, ((3088 - baseX) * 4 + 2) - myPlayer.x / 32, ((3506 - baseY) * 4 + 2) - myPlayer.y / 32);
        markMinimap(map4, ((3097 - baseX) * 4 + 2) - myPlayer.x / 32, ((3512 - baseY) * 4 + 2) - myPlayer.y / 32);
        markMinimap(map5, ((3094 - baseX) * 4 + 2) - myPlayer.x / 32, ((3485 - baseY) * 4 + 2) - myPlayer.y / 32);
        markMinimap(map6, ((2143 - baseX) * 4 + 2) - myPlayer.x / 32, ((5536 - baseY) * 4 + 2) - myPlayer.y / 32);
   ...
   loadAllOrbs(Configuration.clientSize == 0 ? 0 : Configuration.clientWidth - 217);
	...
	public void drawLoginScreen(boolean flag) {
		...
		//	fadeValue += 5;
		//}
	//	aBackground_967.drawAdvancedSprite(0, 0, fadeValue);
		...
		if (loginScreenState == 3) {
			chatTextDrawingArea.method382(0xffff00, c / 2, "OS-WORLD.org",
					c1 / 2 - 60, true);
			int k = c1 / 2 - 35;
			chatTextDrawingArea.method382(0xffff00, c / 2,
					"", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffff00, c / 2, "", k,
					true);
			k += 15;
			chatTextDrawingArea.method382(0xffff00, c / 2, "",
					k, true);
        ...
        try {
           ...
           case 217:
            ...
            case 241:
                ...
                aTextDrawingArea_1271.drawText(0x2d2d2d, "Loading - please wait", 17, 67);
                gameScreenIP.drawGraphics(4, super.graphics, 4);
                if (pktType == 73) {
                    int k16 = 0;
                ...
                if (!flag5 && anInt1251 == 0)
                    try {
                        ...
                        case 14:
                            ...
                            break;
                        case 15:
                            pushMessage(s9, 7, "@cr27@" + TextClass.fixName(TextClass.nameForLong(l5)));
                            break;
                        case 16:
                            pushMessage(s9, 7, "@cr28@" + TextClass.fixName(TextClass.nameForLong(l5)));
                            break;
                        case 32:
                            pushMessage(s9, 7, "@cr32@" + TextClass.fixName(TextClass.nameForLong(l5)));
                            break;
                        case 31:
                            pushMessage(s9, 7, "@cr31@" + TextClass.fixName(TextClass.nameForLong(l5)));
                            break;
                        default:
                ...
                try {
                    ...
                    if (frame == 35000) {
    					try {
    						...
    						if (args.length == 4) {
    							boolean isNPC = Boolean.parseBoolean(args[0]);
    							
    							int opponent_id = Integer.parseInt(args[1]);
    							
    							if (isNPC) {
    								opponent1 = npcArray[opponent_id];
    							} else {
    								opponent1 = playerArray[opponent_id];
    							}
    							
    							currentHealth = Integer.parseInt(args[2]);
    							maxHealth = Integer.parseInt(args[3]);
    						}
    					} catch (Exception e) {
    						e.printStackTrace();
    					}
    ...
    private void processMinimapActions() {
		...
		if (counterHover && loadOrbs) {
			menuActionName[2] = counterOn ? "Hide XP drops" : "Show XP drops";
			menuActionID[2] = 474;
			menuActionName[1] = "Reset XP drops";
			menuActionID[1] = 475;
			menuActionRow = 3;
		}
		  if (worldHover && loadOrbs) {
			   menuActionName[2] = "Global Teleports";
			   menuActionID[2] = 1337;
			   menuActionRow = 2;
			   menuActionName[1] = "Last Destination";
			   menuActionID[1] = 1777;
			   menuActionRow = 3;
			  }
	...
	private void drawosrsspec() {
        ...
        if (loadOrbs) {// ok sean this calls to see if all the orbs are activated
            String value = RSInterface.interfaceCache[155].message;
				int spec = Integer.parseInt(value); // this one shows the results of the spec
        if (specialHover) // this is where the special orb starts
                cacheSprite[56].drawSprite(Configuration.clientSize == 0 ? 153 : Configuration.clientWidth - 63, Configuration.clientSize == 0 ? 131 : 150);
		else
            cacheSprite[42].drawSprite(Configuration.clientSize == 0 ? 154 : Configuration.clientWidth - 62, Configuration.clientSize == 0 ? 132 : 151);
		cacheSprite[5].drawSprite(Configuration.clientSize == 0 ? 157 : Configuration.clientWidth - 58, Configuration.clientSize == 0 ? 135 : 155);
					if (spec == 0) {
					...
					//cacheSprite[5].drawSprite(Configuration.clientSize == 0 ? 157 : Configuration.clientWidth - 58, Configuration.clientSize == 0 ? 135 : 155);
							cacheSprite[55].drawSprite(Configuration.clientSize == 0 ? 162 : Configuration.clientWidth - 53, Configuration.clientSize == 0 ? 140 : 160);
								smallText.method382(getOrbTextColor(spec), Configuration.clientSize == 0 ? 198 : Configuration.clientWidth - 19, Integer.toString(spec), Configuration.clientSize == 0 ? 158 : 177, true);
        }
    }

    public boolean isPoisoned, clickedQuickPrayers, isDiseased, isEnvenomed;
 
    public void drawSpecOrb() {
		int xOffset = Configuration.clientSize == 0 ? 180 : Configuration.clientWidth - 60;
		//String currentSpec = RSInterface.interfaceCache[4532].message;
		//currentSpec = currentSpec.replaceAll("%", "");
	
            String value = RSInterface.interfaceCache[155].message;
            int spec = Integer.parseInt(value);
		ORBSNEW[0] = new Sprite(Signlink.findcachedir() + "Sprites/Gameframe/ORBS 29.png", 27, getOrbFill(100));

		ORBSNEW[16].drawSprite(xOffset + -1, 124);
		ORBSNEW[15].drawSprite(xOffset + 27, 129);
		ORBSNEW[0].drawSprite(xOffset + 27, 129);
		ORBSNEW[12].drawSprite(xOffset + 32, 134);
		smallText.method382(getOrbTextColor(100), xOffset + 14, "" + spec, 151, true);
	}
	 ...
	 * hp orb x = - y = -
	 */
	orbX = { 1, 1, 25 }, orbY = { 41, 85, 121 }, orbTextX = { 16, 16, 40 }, orbTextY = { 67, 111, 147 }, coloredOrbX = { 28, 28, 52 }, coloredOrbY = { 45, 89, 125 }, currentInterface = { 4016, 4012, 149 }, maximumInterface = { 4017, 4013, 149 },

			orbIconX = { 34, 32, 59 }, orbIconY = { 50, 92, 129 };
    
    
    
	/*public final int[] orbX = { 1, 9, 41 }, orbY = { 68, 105, 132 },
			orbTextX = { 16, 25, 57 }, orbTextY = { 94, 131, 158 },
			coloredOrbX = { 28, 36, 68 }, coloredOrbY = { 72, 109, 136 },
			currentInterface = { 4016, 4012, 149 }, maximumInterface = { 4017,
					4013, 149 }, orbIconX = { 34, 39, 75 }, orbIconY = { 78,
					112, 140 };
  /*  public final int[] orbX = { 0, 0, 25 };
    public final int[] orbY = { 41, 85, 121 };
    public final int[] orbTextX = { 15, 15, 40 };
    public final int[] orbTextY = { 67, 111, 147 };
    public final int[] coloredOrbX = { 27, 27, 52 };
    public final int[] coloredOrbY = { 45, 89, 125 };
    ...
    public final int[] orbIconY = { 52, 93, 129 };*/
    ...
    /*private void loadAllOrbs(int xOffset) {
		...
		if (Configuration.clientSize == 0 ? super.mouseX >= 517 && super.mouseX <= 545 && super.mouseY >= 45 && super.mouseY <= 70 :
			super.mouseX >= Configuration.clientWidth - 185 && super.mouseX <= Configuration.clientWidth - 158 && super.mouseY >= 40 && super.mouseY <= 66 ) {
			cacheSprite[22].drawSprite(loadOrbs && Configuration.clientSize == 0 ? 1 : Configuration.clientWidth - 210, Configuration.clientSize == 0 ? 20 : 20);
		} else {
			cacheSprite[23].drawSprite(loadOrbs && Configuration.clientSize == 0 ? 1 : Configuration.clientWidth - 210, Configuration.clientSize == 0 ? 20 : 20);
		}
		if(Configuration.clientSize == 0) {
  ...
  /*  private void drawXpCounter() {
		int y;
		int xOffset = Configuration.clientSize == 0 ? 1 : Configuration.clientWidth - 244;
		int OtherxOffset = Configuration.clientSize == 0 ? 516 : Configuration.clientWidth - 244;
		int x1 = mouseX;
		int y1 = mouseY;
		y = 47;
		y += -25;
		if (counterOn) {
			// cacheSprite3[22].drawSprite(xOffset, y);
			Sprite spriteGlow = new Sprite(Signlink.findcachedir() + "sprites/Gameframe/ORBS 34.png", 27, 30);
			spriteGlow.drawAdvancedSprite(xOffset, y);
		} else
			cacheSprite[((Client.inCircle(OtherxOffset, 22, x1, y1, 14) ? 24 : 23))].drawSprite(xOffset, y);
	}*/
    ...
    private void drawCounterOnScreen() {
       // if (!Configuration.enableOrbs)
        ...
        if (Configuration.clientSize == 0) {
            cacheSprite[62].drawAdvancedSprite(390, 2);//390,2
        } else {
            cacheSprite[62].drawAdvancedSprite(Configuration.clientWidth - 350, 6);
        }
    
        if (Configuration.clientSize == 0) {
            cacheSprite[61].drawSprite(393, 6);
        } else {
            cacheSprite[61].drawSprite(Configuration.clientWidth - 345, 8);
        }
        ...
        // smallText.method382( 0xFFFFFF, Configuration.clientSize == 0 ? x - i - digits : x - 22 - i - digits, amount, y - (Configuration.clientSize == 0 ? 21 : 19), true);
 
      //smallText.method382( 0xFFFFFF, Configuration.clientSize == 0 ? x - i - digits : x - 12 - i - digits, amount, y - (Configuration.clientSize == 0 ? 21 : 19), true);
        smallText.method382(0xFFFFFD, Configuration.clientSize == 0 ? x - 12 - i - digits : x - 22 - i - digits, amount,
               y - 25, true);
            ...
            if (xp_added[i][0] > -1) {
                if (xp_added[i][2] > 0) {
                    ...
                    for(int i2 = 0; i2 < skill_sprites.length; i2++) {
                        ...
                        sprite.drawSprite(
                                Configuration.clientSize == 0 ? x - a + 12 - xp_font.getTextWidth(s) - icons_x_off
                                        : x - a + 0 - xp_font.getTextWidth(s) - icons_x_off,
                                expY + 131 + (140 - xp_added[i][2]) - (font_height / 2) - (sprite.myHeight / 2),
                                transparency);
                    }
...
private boolean xp_merge = false;
    ...
    private boolean runHover, prayHover, hpHover, prayClicked, counterOn, sumHover, sumActive, counterHover,
            specialHover, worldHover, autocast, runClicked = true;
    ...
    public static Sprite[] equipmentIcon;
    ...
    private String prayerBook = "Regular";
