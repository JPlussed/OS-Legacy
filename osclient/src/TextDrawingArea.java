...
public final class TextDrawingArea extends DrawingArea {
	...
	public void drawString(int drawX, int color, String s, int seed, int drawY)
    {
        if(s == null)
            return;
        aRandom1498.setSeed(seed);
        int j1 = 192 + (aRandom1498.nextInt() & 0x1f);
        drawY -= anInt1497;
        for(int k1 = 0; k1 < s.length(); k1++)
        {
            ...
            if(c != ' ')
            {
                method394(192, drawX + anIntArray1494[c] + 1, aByteArrayArray1491[c], anIntArray1492[c], drawY + anIntArray1495[c] + 1, anIntArray1493[c], 0);
                method394(j1, drawX + anIntArray1494[c], aByteArrayArray1491[c], anIntArray1492[c], drawY + anIntArray1495[c], anIntArray1493[c], color);
            }
