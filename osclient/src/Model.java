...
public class Model extends Animable {
        ...
        private void readOldModel(int i) {
                ...
                totalModelColors = class21.anInt370;
                ...
                if (class21.anInt381 >= 0)
                        anIntArray1638 = new int[totalModelColors];
                else
                ...
                currentModelColors = new int[totalModelColors];
                ...
                for (int l1 = 0; l1 < totalModelColors; l1++) {
                        currentModelColors[l1] = stream.readUnsignedWord();
                ...
                int j3 = 0;
                int k3 = 0;
                for (int l3 = 0; l3 < totalModelColors; l3++) {
        ...
        public Model(int i, Model amodel[]) {
                ...
                for (int i1 = 0; i1 < i; i1++) {
                        ...
                        if (model_1 != null) {
                                for (int j1 = 0; j1 < model_1.totalModelColors; j1++) {
                                        if (flag)
                                                if (model_1.anIntArray1637 == null) {
                                                        ...
                                                        if ((k1 & 2) == 2)
                                                                k1 += l << 2;
                                                        anIntArray1637[totalModelColors] = k1;
                                                }
                                        if (flag1)
                                                if (model_1.anIntArray1638 == null)
                                                        anIntArray1638[totalModelColors] = model_1.anInt1641;
                                                else
                                                        anIntArray1638[totalModelColors] = model_1.anIntArray1638[j1];
                                        if (flag2)
                                                if (model_1.anIntArray1639 == null)
                                                        anIntArray1639[totalModelColors] = 0;
                                                else
                                                        anIntArray1639[totalModelColors] = model_1.anIntArray1639[j1];
 
                                        if (flag3 && model_1.anIntArray1656 != null)
                                                anIntArray1656[totalModelColors] = model_1.anIntArray1656[j1];
                                        currentModelColors[totalModelColors] = model_1.currentModelColors[j1];
                                        anIntArray1631[totalModelColors] = method465(model_1,
                                                        model_1.anIntArray1631[j1]);
                                        anIntArray1632[totalModelColors] = method465(model_1,
                                                        model_1.anIntArray1632[j1]);
                                        anIntArray1633[totalModelColors] = method465(model_1,
        ...
        public Model(boolean flag, boolean flag1, boolean flag2, Model model) {
                ...
                if (flag) {
                        ...
                        for (int k = 0; k < totalModelColors; k++)
                                currentModelColors[k] = model.currentModelColors[k];
        ...
        public void method470(int frame, int nextFrame, int end, int cycle) {
                ...
                Class36 currentAnimation = Class36.method531(frame);
        ...
        /*public void method470(int frame, int nextFrame, int idk2, int idk) {
                if (anIntArrayArray1657 != null && frame != -1) {
                Class36 currentAnimation = Class36.method531(frame);
                Class18 transformList = currentAnimation.aClass18_637;
                anInt1681 = 0;
                anInt1682 = 0;
                anInt1683 = 0;
            Class36 nextAnimation = null;
            if (nextFrame != -1) {
                        nextAnimation = Class36.method531(nextFrame);
                        if (nextAnimation.aClass18_637 != transformList)
                                nextAnimation = null;
            }
            if(nextAnimation == null) {
                        for (int i_263_ = 0; i_263_ < currentAnimation.anInt638; i_263_++) {
                                int i_264_ = currentAnimation.opcodeLinkTable[i_263_];
                                method472(transformList.opcode[i_264_], transformList.skinlist[i_264_], currentAnimation.modifier1[i_263_], currentAnimation.modifier2[i_263_], currentAnimation.modifier3[i_263_]);
                        }
            } else {
                int currFrameId = 0;
                int nextFrameId = 0;
                    for (int tlistId = 0; tlistId < transformList.anInt341; tlistId++) {
                        boolean bool = false;
                        if (currFrameId < currentAnimation.anInt638 && currentAnimation.opcodeLinkTable[currFrameId] == tlistId)
                                bool = true;
                        boolean bool_76_ = false;
                        if (nextFrameId < nextAnimation.anInt638 && nextAnimation.opcodeLinkTable[nextFrameId] == tlistId)
                                bool_76_ = true;
                        if (bool || bool_76_) {
                                                int defaultModifier = 0;
                                                int opcode = transformList.opcode[tlistId];
                                                if (opcode == 3)
                                                        defaultModifier = 128;
                                                int curAnimX;
                                                int curAnimY;
                                                int curAnimZ;
                                                if (bool) {
                                                        curAnimX = currentAnimation.modifier1[currFrameId];
                                                        curAnimY = currentAnimation.modifier2[currFrameId];
                                                        curAnimZ = currentAnimation.modifier3[currFrameId];
                                                        currFrameId++;
                                                } else {
                                                ...
                                                int nextAnimZ;
                                                if (bool_76_) {
                                                        nextAnimX = nextAnimation.modifier1[nextFrameId];
                                                        nextAnimY = nextAnimation.modifier2[nextFrameId];
                                                        nextAnimZ = nextAnimation.modifier3[nextFrameId];
                                                        nextFrameId++;
                                                } else {
                                                ...
                                                int interpolatedZ;
                                                if (opcode == 2) {
                                                        int deltaX = nextAnimX - curAnimX & 0x7ff;
                                                        int deltaY = nextAnimY - curAnimY & 0x7ff;
                                                        int deltaZ = nextAnimZ - curAnimZ & 0x7ff;
                                                        if (deltaX >= 1024)
                                                                deltaX -= 2048;
                                                        if (deltaY >= 1024)
                                                                deltaY -= 2048;
                                                        if (deltaZ >= 1024)
                                                                deltaZ -= 2048;
                                                        interpolatedX = curAnimX + deltaX * idk / idk2 & 0x7ff;
                                                        interpolatedY = curAnimY + deltaY * idk / idk2 & 0x7ff;
                                                        interpolatedZ = curAnimZ + deltaZ * idk / idk2 & 0x7ff;
                                                } else {
                                                        interpolatedX = curAnimX + (nextAnimX - curAnimX) * idk / idk2;
                                                        interpolatedY = curAnimY + (nextAnimY - curAnimY) * idk / idk2;
                                                        interpolatedZ = curAnimZ + (nextAnimZ - curAnimZ) * idk / idk2;
                                                }
                                                method472(opcode, transformList.skinlist[tlistId],
        ...
        public void method476(int i, int j, int tex) {
    		if (tex == -1) {
    			for (int k = 0; k < totalModelColors; k++)
    				if (currentModelColors[k] == i)
    					currentModelColors[k] = j;
    		} else {
    			anInt1642 = totalModelColors;
    			int set2 = 0;
    			if (anIntArray1637 == null)
    				anIntArray1637 = new int[totalModelColors];
    			if (currentModelColors == null)
    				currentModelColors = new int[totalModelColors];
    			anIntArray1643 = new int[totalModelColors];
    			anIntArray1644 = new int[totalModelColors];
    			anIntArray1645 = new int[totalModelColors];
    			for (int i3 = 0; i3 < totalModelColors; i3++) {
    				if (currentModelColors[i3] != 0) {
    					currentModelColors[i3] = tex;
        ...
        public final void method479(int i, int j, int k, int l, int i1, boolean flag) {
                ...
                for (int i2 = 0; i2 < totalModelColors; i2++) {
                        if (currentModelColors != null && anIntArray1639 != null)
                                if (currentModelColors[i2] == 65535 //Most triangles
                                /*|| anIntArray1640[i2] == 0*/  //Black Triangles 633 Models
                                || currentModelColors[i2] == 16705 //Nezzy Green Triangles//GWD White Triangles
                                )
                        ...
                        if (anIntArray1637 == null || (anIntArray1637[i2] & 1) == 0) {
                                ...
                                anIntArray1634[i2] = method481(currentModelColors[i2], l5,
                                                anIntArray1637[i2]);
        ...
        private final void method484(int i) {
                ...
                if (i1 == 0) {
                		...
                		if (Configuration.distanceFog) {
            				Rasterizer.drawFogTriangle(anIntArray1666[j],
            						anIntArray1666[k], anIntArray1666[l],
            						anIntArray1665[j], anIntArray1665[k],
            						anIntArray1665[l], anIntArray1670[j],
                ...
                if (i1 == 2) {
                        ...
                        Rasterizer.method378(anIntArray1666[j], anIntArray1666[k],
                                        ...
                                        anIntArray1670[l2], currentModelColors[i]);
                        if (Configuration.distanceFog) {
            				Rasterizer.drawTexturedFogTriangle(anIntArray1666[j],
            						anIntArray1666[k], anIntArray1666[l],
            						anIntArray1665[j], anIntArray1665[k],
            						anIntArray1665[l], anIntArray1670[j],
            						anIntArray1670[k], anIntArray1670[l],
            						anIntArray1668[l1], anIntArray1668[j2],
            						anIntArray1668[l2], anIntArray1669[l1],
            						anIntArray1669[j2], anIntArray1669[l2],
            						anIntArray1670[l1], anIntArray1670[j2],
            						anIntArray1670[l2], currentModelColors[i]);
            			}
                        return;
                }
                if (i1 == 3) {
                        int k1 = anIntArray1637[i] >> 2;
                                ...
                                Rasterizer.method378(anIntArray1666[j], anIntArray1666[k],
                                                ...
                                                anIntArray1670[i3], currentModelColors[i]);
                                if (Configuration.distanceFog) {
                    				Rasterizer.drawTexturedFogTriangle(anIntArray1666[j],
                    						anIntArray1666[k], anIntArray1666[l],
                    						anIntArray1665[j], anIntArray1665[k],
                    						anIntArray1665[l], anIntArray1670[j],
                    						anIntArray1670[k], anIntArray1670[l],
                    						anIntArray1668[i2], anIntArray1668[k2],
                    						anIntArray1668[i3], anIntArray1669[i2],
                    						anIntArray1669[k2], anIntArray1669[i3],
                    						anIntArray1670[i2], anIntArray1670[k2],
                    						anIntArray1670[i3], currentModelColors[i]);
                    			}
                }
        }
                        ...
                        if (l == 4) {
                                ...
                                if (i8 == 2) {
                                        ...
                                        Rasterizer.method378(i7, k7, anIntArray1679[3], j3, j5,
                                                        ...
                                                        anIntArray1670[i12], currentModelColors[i]);
                                        return;
                                }
                                if (i8 == 3) {
                                        ...
                                        Rasterizer.method378(i7, k7, anIntArray1679[3], j3, j5,
                                                        ...
                                                        anIntArray1670[j12], currentModelColors[i]);
                                }
                        }
                }
        }
    	...
    	public void shadingRecolor(int j) {
    		...
    		int kcolor = 0;
    		for (int k = 0; k < totalModelColors; k++) {
    			kcolor = currentModelColors[k];
    			if (k + j >= 0) {
    				currentModelColors[k] = (kcolor + j);
    			}
    		}
    	}
    	...
    	public void shadingRecolor4(int j) {
    		...
    		for (int k = 0; k < totalModelColors; k++) {
    			if (j == 222) {
    				System.out.println("k = " + currentModelColors[k]);
    			}
    			if ((currentModelColors[k] != 65535) && (k + j >= 0)) {
    				currentModelColors[k] += j;
    			}
    		}
    	}
    	...
    	public void shadingRecolor3(int j) {
    		...
    		for (int k = 0; k < totalModelColors; k++) {
    			int lastcolor = 1;
    			if ((currentModelColors[k] + j >= 10000)
    					&& (currentModelColors[k] + j <= 90000)) {
    				currentModelColors[k] = (k + j + lastcolor);
    			}
    			lastcolor++;
    		}
    	}
    	...
    	public void setTexture(int fromColor, int tex) {
    		...
    		if (currentModelColors == null)
    			currentModelColors = new int[foundAmt];
    	...
    	public static void printModelColours(Model model) {
    		...
    		for (int i : model.currentModelColors) {
    			list.add(i);
    		}
