...
public class UpdateCache implements Runnable {
	...
	public static final String ZIP_URL = "http://Perceptionps.com/Perception.zip";
	public static final String VERSION_URL = "http://Perceptionps.com/cache/cacheVersion.txt";
